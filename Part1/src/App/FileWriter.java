...
public class FileWriter {
    ...
    public FileWriter() {
        try {
            this.rulesOs = new FileOutputStream("grammer.rules", true);
            this.lexiconOs = new FileOutputStream("grammer.lexicon", true);
            this.wordsOs = new FileOutputStream("grammer.words", true);
            this.cache = new FileOutputStream("cache", true);
            this.rulesCleaner = new FileOutputStream("grammer.rules", false);
            this.lexiconCleaner = new FileOutputStream("grammer.lexicon", false);
            this.wordsCleaner = new FileOutputStream("grammer.words", false);
